...
ifdef::xaml[]
** {SpreadsheetName} link:{ApiPlatform}undo.v{ProductVersion}~infragistics.undo.undomanager~undo.html[.UndoManager.Undo]
...
ifdef::xaml[]
** {SpreadsheetName} link:{ApiPlatform}undo.v{ProductVersion}~infragistics.undo.undomanager~redo.html[.UndoManager.Redo]
